...
def contact():
    mess._show(title='Contact us', message="Please contact us on : gamingkeybo@gmail.com' ") 
...
def TakeImages():
    ...
    columns = ['SERIAL NO.', '', 'Ids', '', 'Student NAME']
...
lbl = tk.Label(frame2, text="Enter System ID",width=20  ,height=1  ,fg="black"  ,bg="#c79cff" ,font=('comic', 17, ' bold ') )
lbl.place(x=80, y=55)
